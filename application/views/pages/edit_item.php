            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- /.col-lg-12 -->
                       ...
                       <form role="form" method="post" action="<?= site_url('purchase_v1/dashboard/updateItem'); ?>">
                                              ...
                                              <div class="form-group">
                                                        ...
                                                        <div class=" col-md-4"> 
                                                            ...
                                                            <?php foreach ($lvl as $key) {
                                                                ?>
                                                    <option value="<?= $key->catt_id; ?>"
                <?php if($key->catt_id == $arr->cat_id){echo " selected ";} ?>>
                                                    <?= $key->cat_name; ?>
                                        ...
                                        <input type="hidden" name="id" id="inputId" class="form-control" value="<?= $arr->item_id; ?>">
                                        <div class="clear" style="height: 50px;"></div>                
                    </form>
