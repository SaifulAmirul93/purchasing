...
<div class=" col-md-4">
    <div class="form-group">
        <label>Name</label>
        <input class="form-control" name="supplier_name" id="supplier_name" disabled="" value = "<?= $supplier->su_name; ?>">                                     
    </div>
</div>
<div class=" col-md-4">
    <div class="form-group">
        <label>Company</label>
        <input class="form-control"  name="supplier_company" id="supplier_company" disabled="" value = "<?= $supplier->su_company; ?>">
...
<div class=" col-md-4">
    <div class="form-group">
        ...
        <input class="form-control" name="supplier_contact" id="supplier_contact" disabled="" value = "<?= $supplier->su_contact; ?>">
        <!-- <p class="help-block">Example block-level help text here.</p> -->
    </div>
</div>
...
<div class=" col-md-4">
    <div class="form-group">
        <label>Email</label>
        <input class="form-control" name="supplier_email" id="supplier_email" disabled="" value = "<?= $supplier->su_email; ?>">
        <!-- <p class="help-block">Example block-level help text here.</p> -->
    </div>
</div>
