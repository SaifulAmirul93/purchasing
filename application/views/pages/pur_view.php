  ...
  <div class="contemporary-template__items">
    <table class="table table-bordered">
      ...
      <?php 
        ...
        <td style="color: #000000;text-align: right;" colspan="10"><strong>SUB TOTAL : </strong></td>
         ...
         <tr>
          ...
          <td style="color: #000000;"><input type="text" id="gst" style="width:100px;" name="gst" class="w3-input w3-border-0" required  value="<?= $curr; ?> <?= number_format((float)$gst, 2, '.', '');?>"> </td>
          </tr>
          <?php
          }else if($arr['purchase']->currency == 2){
            //$gst=$sub_total*0.06; 
      ...
      ?>
          ...
          <td style="color: #000000;"><input type="text" id="grand" style="width:100px;" name="grand" class="w3-input w3-border-0" required  value="<?= $curr; ?> <?= number_format((float)$grand, 2, '.', '');?>"> </td>
        </tr>      
      </tbody>
    </table>
  </div>
