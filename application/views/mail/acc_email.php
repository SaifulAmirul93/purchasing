			...
			<tbody><tr>
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
					...
					<p style="text-align:center;margin:0;padding:0;">
						<img src="<?= base_url(); ?>dist/img/purchase.png" style="max-width:600px;display:inline-block;">
					</p>
          <br>
				</td>
			</tr>
			<tr>
				<td align="center" valign="top">
                  ...
                  <tr>
                        ...
                        <p>
                          Hi Account Dept,<br><br>
                          The following in this email is the Purchase Order information that payment should be made as soon as possible.
                        </p>  
